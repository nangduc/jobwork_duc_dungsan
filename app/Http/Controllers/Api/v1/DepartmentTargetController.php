...
use App\Http\Resources\DepartmentTarget\DepartmentTargetCollect<?php
...
class DepartmentTargetController extends Controller
{
  ...
  public function __construct(DepartmentTarget $departmentTarget,Department $department)
  {
    $this->departmentTarget = $departmentTarget;
    $this->department = $department;
  }
